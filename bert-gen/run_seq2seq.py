...
def get_args():
    ...
    parser.add_argument("--train_file", default="../../commongen.train.json", type=str, 
                        help="Training data (json format) for training. Keys: source and target")
    parser.add_argument("--model_type", default=None, type=str, required=True,
                        help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()))
    parser.add_argument("--model_name_or_path", default=None, type=str, 
                        help="Path to pre-trained model or shortcut name selected in the list:")
    parser.add_argument("--output_dir", default="../../tmp/finetuned_models", type=str, 
    ...
    parser.add_argument("--cache_dir", default="../../tmp/transformer_package_cache", type=str,
